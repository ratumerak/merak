...
<html><head>
	...
	<style>
		...
		<!-- <h6 style="font-weight: bold;">Total Topup : <?= $total_topup['jumlah_topup'] ?> Paket / <?= $total_topup['qty'] ?> Sak Beras </h6> -->
		...
		<!-- <h6 style="font-weight: bold">Total Uang Masuk : <?= "Rp " . number_format($total_harga['harga'],2,',','.');  ?> </h6> -->
