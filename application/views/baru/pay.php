...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">  <div class="modal-dialog" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
         ...
         <input type="submit" name="kirim" value="Save" class="btn btn-danger">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="card-title">Order Ratumerak</h4>
		<?php  if ($profil == false) { ?>
		<div class="alert alert-success" role="alert">

                    Hello  <b><?= $this->session->username ?></b>, Untuk melakukan order ratumerak, anda harus mengisi <a href="#"  data-toggle="modal" data-target="#myModal">profil</a> terlebih dahulu.

                    </div>
		<?php }else{ ?>

 		<img class="d-block w-100 mb-3" src="<?= base_url('assets_baru/images/ratu.png') ?>" alt="Second slide" style="border-radius: 10px;">
                  ...
                  <?php }else{ ?>
                      ...
                      <?php if ($pay['status'] == 200) {?>
                         ...
                         <div class="alert alert-success" role="alert">
                          Hello  <b><?= $this->session->username ?></b>. Selamat produk ratumerak anda sekarang sudah tersedia.
                          </div>
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="card">
                          ...
                          <div class="card-body">
                            ...
                            <h5 class="card-title text-primary">Akun member</h5>
                        ...
                        <h5 class="card-title text-primary">Produk</h5>
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number"  class="form-control" name="" min="0" required="" readonly="" value="<?= $user['jumlah_paket'] ?>" name="jumlah_paket">
			...
			<?php 
                        ...
                        ?>
                         ...
                         <div class="form-group">
                            ...
                            <input type="number" readonly=""  class="form-control" name="qty" value="<?= $qty ?>" v-model="stok()"  min="0" required="">
			...
			<?php 
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" readonly="" class="form-control" readonly="" value="<?= $harga ?>" name="harga" v-model="jmlharga()">
