      ...
      <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <h4 class="card-title">Withdraw Bonus Cashback Ratumerak</h4>
               ...
               <div class="col-sm-4">
                ...
                <form method="post" action="">
                  ...
                  <div class="form-group">
                   ...
                   <input type="number" name="nomor_rek" id="nomor_rek" class="form-control" required="" min="50000" required="">
                ...
                <div class="form-group">
                 ...
                 <input type="number" name="penarikan" class="form-control" required="" min="50000" required="" max="<?= $total['total_bonus'] ?> ?>">
