        ...
        <div class="card">
          <div class="card-body">
            ...
            if (isset($tgl)) { ?>
              ...
              <h4 class="card-title">Data Topup Produk Tanggal <?= $tgl ?></h4>
            <?php }else{ ?>
              <h4 class="card-title">Data Topup Produk</h4>
            <?php } ?>
            ...
            <?php if ($topup == false) { ?>
              <center>
                <h4 style="text-align: center; margin-top: 30px;">Data Topup Tidak Tersedia</h4>
              </center>
            <?php }else{ ?>
